...
//   showToast(`Filled with ${endpoint.name}`, "success");
// }
...
//   if (!appState.lastResponse) {
//     showToast("No response to export", "error");
//     return;
//   }
...
function showQuickFillMenu() {
  ...
  // Debug: Check if ModalSystem exists
  console.log("🔍 Checking for ModalSystem:", window.ModalSystem);
